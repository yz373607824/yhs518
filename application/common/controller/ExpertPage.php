...
class ExpertPage extends Paginator
{
    ...
    protected function getLinks()
    {
        ...
        if (is_array($block['first'])) {
            if ($this->currentPage == $this->lastPage && $this->lastPage < $window + 6){
    ...
    {
        return '<a class="'.$style.'" href="' . htmlentities($url) . '">' . $page . '</a>';
    }
