...
class Auth extends \fast\Auth
{
    ...
    // 定义网站管理员的groupid
    const WEB_ADMINISTRATOR_GROUPID = 6;
    ...
    public function login($username, $password, $keeptime = 0)
    {
        ...
        if (Config::get('uwebadmin.login_failure_retry') && $admin->loginfailure >= 10 && time() - $admin->updatetime < 3600) {
    ...
    public function isLogin()
    {
        ...
        if (Config::get('uwebadmin.login_unique')) {
    ...
    public function getChannelRuleIds($uid = null)
    {
        $uid = is_null($uid) ? $this->id : $uid;
        return parent::getChannelRuleIds($uid);
    }
    ...
    public function getSidebar($params = [], $fixedPage = 'dashboard')
    {
        ...
        $menu = $nav = '';
        if (Config::get('uwebadmin.multiplenav')) {
            $topList = [];
