...
function indexEvent() {
    ...
    let $indexBannerSwiper = new Swiper('.index-banner-box .swiper-container', {
        speed: 1000,
        effect : 'fade',
        autoplay: {
            delay: 3000,
    ...
    let $indexExpertSwiper = new Swiper('.expert-list-swiper .swiper-container', {
        speed: 1000,
        autoplay: {
            delay: 5000,
            disableOnInteraction: false
    ...
    let $indexIndustrySwiper_01 = new Swiper('.con-box-01 .swiper-container', {
        speed: 1000,
        autoplay: {
            delay: 3000,
            disableOnInteraction: false
    ...
    let $indexIndustrySwiper_02a = new Swiper('.con-box-02-swiper', {
        speed: 1000,
        autoplay: {
            delay: 3000,
            disableOnInteraction: false
    ...
    // 之前行业新闻的滑动实现方式
    let i;
    let swp_list = $('.con-box-02 .swiper-list').children()
    let wrapper_list = $('.con-box-02 .swiper-wrapper').children()
    swp_list.hide()
    ...
    swp_list.eq(i).show()
    let $indexIndustrySwiper_02 = new Swiper('.con-box-02 .conbox-swp', {
        speed: 1000,
        autoplay: {
            delay: 3000,
            disableOnInteraction: false
...
function swiperArticleEvent() {
    // 专家在线
    let $_swiper_01 = new Swiper('.right-sum-swiper', {
        speed: 1000,
        autoplay: {
            delay: 3000,
            disableOnInteraction: false,
    ...
    // 会员活动
    let $_swiper_02 = new Swiper('.member-activities-swiper', {
        speed: 1000,
        autoplay: {
            delay: 3000,
            disableOnInteraction: false,
    ...
    // 抢购详情
    let $_swiper_03 = new Swiper('.scare-buying-swiper', {
        speed: 1000,
        autoplay: {
            delay: 3000,
            disableOnInteraction: false,
    ...
    // 入驻企业
    let $_swiper_04 = new Swiper('.footer-swiper-wrap .swiper-container', {
        speed: 1000,
        autoplay: {
            delay: 3000,
            disableOnInteraction: false,
    ...
    // 等级页面--企业详情
    let $_swiper_05 = new Swiper('.honor-swiper .swiper-container', {
        speed: 1000,
        autoplay: {
            delay: 3000,
            disableOnInteraction: false,
...
function memberCenterEvent() {
    ...
    $('.js-check-btn').click(function () {
        let cash = $('.cash-num').attr('data-cash')
...
function uploadImg() {
    ...
    $('.c--member-input-file').on('change', function () {
        ...
        let parentOuter = $(this).closest('.outer')
        ...
        if(file.type.indexOf('image') === 0) {
            ...
            reader.onload = function () {
                ...
                let imgHtml = '<img class="c--member-upload-img" data-name="' + fileName +'" src="' + newUrl + '" alt="" />'
                let removeBtn = '<span class="c--member-remove-btn"></span>'
    ...
    $('.file-img-box').on('click', '.c--member-remove-btn', function () {
        $(this).parent().find('.inner-file-img').children().show()
            .end().find('input[type="file"]').val('')
            .end().find('.file-hidden').val('')
            .end().find('.c--member-upload-img').remove()
            .end().parents('.outer').find('.c--member-remove-btn').remove()
    })
...
function recruitmentEvent() {
    $('.recruitment-list').on('click', '.inner-recruitment', function () {
        if($(this).hasClass('on')) {
            ...
            $(this).addClass('on').parent().find('.sub').slideDown('linear')
                .end().siblings().find('.sub').slideUp('linear')
                .end().find('.inner-recruitment').removeClass('on')
        }
    })
}
...
function starRate() {
    ...
    let starV = arguments[0] ? arguments[0] : 0
    let typeStr = arguments[1] ? arguments[1] : 'none'
